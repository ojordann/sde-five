...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	var h1, t0, t1, t2, t3, p, t4, a0, t6, a1, t8;
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			p = element("p");
    			t4 = text("This is a test Ansible Web application by ");
    			a0 = element("a");
    			a0.textContent = "Osinachi Njoku";
    			t6 = text(", built with ");
    			a1 = element("a");
    			...
    			attr_dev(a0, "href", "https://njoku.dev");
    			add_location(a0, file, 12, 45, 151);
    			attr_dev(a1, "href", "https://svelte.dev/");
    			add_location(a1, file, 12, 104, 210);
    			add_location(p, file, 12, 0, 106);
    		},
    ...
    const app = new App({
    	...
    	props: {
    		name: 'Software Deployment and Evolution Task 5',
    	},
    });
